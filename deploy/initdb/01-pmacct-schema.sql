-- pmacct PostgreSQL schema (table version 1), run once on a fresh database.
--
-- The `pmacct` database and role are created automatically by the postgres image from
-- POSTGRES_DB / POSTGRES_USER / POSTGRES_PASSWORD, so this file only creates the tables
-- (the analyzer adds its own tables at runtime via its migrations — see backend/internal/db/migrations).
--
-- Scripts in /docker-entrypoint-initdb.d run only when ./postgres_data is empty; on an existing
-- data directory they are skipped, so this is safe to keep mounted.
...
(0, 'ip'), (1, 'icmp'), (2, 'igmp'), (3, 'ggp'), (4, 'ipencap'), (5, 'st'), (6, 'tcp'), (8, 'egp'),
(9, 'igp'), (17, 'udp'), (18, 'mux'), (27, 'rdp'), (29, 'iso-tp4'), (30, 'netblt'), (37, 'ddp'),
(39, 'idpr-cmtp'), (41, 'ipv6'), (43, 'ipv6-route'), (44, 'ipv6-frag'), (46, 'rsvp'), (47, 'gre'),
(50, 'ipv6-crypt'), (51, 'ipv6-auth'), (55, 'mobile'), (56, 'tlsp'), (58, 'ipv6-icmp'), (59, 'ipv6-nonxt'),
(60, 'ipv6-opts'), (80, 'iso-ip'), (83, 'vines'), (88, 'eigrp'), (89, 'ospf'), (90, 'sprite-rpc'),
(93, 'ax-25'), (94, 'ipip'), (98, 'encap'), (102, 'pnni'), (108, 'IPcomp'), (111, 'ipx-in-ip'),
